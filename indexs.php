                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    <!-- Cart Area -->
                                    <div class="cart">
                                        <a href="#" id="header-cart-btn" target="_blank"><span class=""></span> <i class="ti-bag"></i>ระเป๋า</a>
	...
	<?php } ?>
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg1.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="bounceInDown" data-delay="0" data-duration="500ms" class="font44"></i><font size="5">เฉพาะในวันนี้เรามีบริการจัดส่งฟรี</font></a></h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms " class="font44">หนังสือการ์ตูน</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInUp" data-delay="1s" data-duration="500ms">ซื้อเลย</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg2.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms" class="font44"></i><font size="5">เฉพาะในวันนี้เรามีบริการจัดส่งฟรี</font></a></h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms" class="font44">หนังสือนิยาย</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInLeftBig" data-delay="1s" data-duration="500ms">ซื้อเลย</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php foreach ($result_product as $row_product)?>
	...
	<?php
		foreach ($result_type as $row )  { ?>
		 ...
		 <a href="index.php"class="btn active"  data-filter=".women"> 
		 	<?php echo $row["type_name"]; ?></a>
